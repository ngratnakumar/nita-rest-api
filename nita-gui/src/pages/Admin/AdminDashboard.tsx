import { Users, Shield, Server, Activity, Lock } from 'lucide-react';
...
export default function AdminDashboard() {
  const tools = [
    ...
    { name: 'Roles Management', desc: 'Create, edit & delete roles', icon: Lock, path: '/admin/roles-config', color: 'bg-rose-500' },
